...
`title` - наименования товара для отображения в интерфейсе;
`category` - категория товара;
`price` - стоимость товара; значение `null` = "Бесценно";
...
`email` - хранит в себе адресс эл. почты покупателя;
`phone` - содержит номер телефона покупателя;
`address` - хранит адресс покупателя, куда будет произведена доставка;
